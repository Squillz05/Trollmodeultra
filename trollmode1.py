...
def main():
    ...
    # NEW: argument parser for IP-based naming
    parser = argparse.ArgumentParser()
    parser.add_argument("--ip", help="IP address to use for naming output JSON", default=None)
    ...
    results["_metadata"] = {
        ...
        "generated_readable": now_utc.strftime("%B %d, %Y %H:%M UTC")
    }

    # If IP provided, override naming
    if args.ip:
        output_file = f"{args.ip}.json"
    else:
